...
import './Class3.css'
const data=[     // we can also make an another file.js and export const data=[{------}] and by import by import keyword
    {
      "albumId": 1,
      "id": 1,
...
const Profile=()=>{
  return(
    ...
    <img src="https://via.placeholder.com/150/92c952" alt="no-inage" />
    <h2 className="title">accusamus beatae ad facilis cum similique qui sunt</h2>
    <a className="button" href="https://via.placeholder.com/600/92c952">details</a>
    </article>
  );
}*/
const Profile=(props)=>{ //const Profile=({title,thumbnailUrl,url})=>{
  ...
  return(
    ...
    <a className="button" href={url}>details</a>
    </article>
  );
};
